...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <div>
      <aside
        className={`flex flex-col bg-[#111827] text-[#9CA3AF] px-6 gap-5 h-screen lg:w-[18rem]
      ...
      {isOpen && (
        ...
        >
          <button
            onClick={toggleSidebar}
            className="absolute top-3 right-0 text-[#efeff0] hover:text-[#fff] focus:outline-none p-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
...
// fixed lg:static inset-y-0 left-0 lg:z-0 z-50 lg:transform-none
// ease-in-out duration-300 ${
